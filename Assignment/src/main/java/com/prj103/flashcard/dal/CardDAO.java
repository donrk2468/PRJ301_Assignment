package com.prj103.flashcard.dal;

import com.prj103.flashcard.model.Card;
import com.prj103.flashcard.model.DBContext;
...
public class CardDAO {
    ...
    /**
     * Lấy danh sách cards theo deckId
     */
    ...
    /**
     * Thêm một card mới, trả về cardId vừa chèn (hoặc -1 nếu lỗi)
     */
    ...
    /**
     * Cập nhật card (trả về true nếu thành công)
     */
    ...
    public Card getRandomCardInDeck(int deckId) {
        // Cách đơn giản dùng ORDER BY NEWID() (SQL Server)
